...
namespace FI.AtividadeEntrevista.DAL
{
    ...
    internal class DaoCliente : AcessoDados
    {
        ...
        internal long Incluir(DML.Cliente cliente)
        {
            ...
            DataSet ds = base.Consultar("FI_SP_IncCliente_V4", parametros);
            long ret = 0;
        ...
        internal bool VerificarExistencia(string CPF, long idAtual = 0)
        {
            List<System.Data.SqlClient.SqlParameter> parametros = new List<System.Data.SqlClient.SqlParameter>();

            parametros.Add(new System.Data.SqlClient.SqlParameter("CPF", CPF));
            parametros.Add(new System.Data.SqlClient.SqlParameter("IdAtual", idAtual));

            DataSet ds = base.Consultar("FI_SP_VerificaCliente_V2", parametros);
